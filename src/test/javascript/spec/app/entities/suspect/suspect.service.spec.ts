...
describe('Service Tests', () => {
  describe('Suspect Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Suspect(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Suspect', async () => {
      ...
      it('should update a Suspect', async () => {
        const returnedFromService = Object.assign(
          {
            firstName: 'BBBBBB',
            lastName: 'BBBBBB',
            lastKnownAddress: 'BBBBBB'
          },
          elemDefault
        );
      ...
      it('should return a list of Suspect', async () => {
        const returnedFromService = Object.assign(
          {
            firstName: 'BBBBBB',
            lastName: 'BBBBBB',
      ...
      it('should delete a Suspect', async () => {
