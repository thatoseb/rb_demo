...
import { IIncident, Incident, IncidentStatus } from 'app/shared/model/incident.model';
...
describe('Service Tests', () => {
  describe('Incident Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Incident(0, currentDate, IncidentStatus.OPEN, 'AAAAAAA', 'AAAAAAA');
    });
